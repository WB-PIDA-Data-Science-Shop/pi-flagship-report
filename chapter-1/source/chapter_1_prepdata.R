...
setwd("C:/Users/wb582704/OneDrive - WBG/Public institutions flagship/replication/chapter 1")
...
# save
write_csv(BOOST, file = "data/output/boost_clean.csv")
...
GTMI <- read_xlsx("data/WBG_GovTech Dataset_Oct2022.xlsx", sheet = "CG_GTMI_Data")
REG <- read_dta("data/regional classification.dta")
...
# save gtmi
write_csv(GTMI, file = "data/output/gtmiwide_clean.csv")
